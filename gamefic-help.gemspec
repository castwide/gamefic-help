...
require_relative 'lib/gamefic/help/version'

Gem::Specification.new do |spec|
  spec.name = 'gamefic-help'
  spec.version = Gamefic::Help::VERSION
  spec.authors = ['Fred Snyder']
  spec.email = ['fsnyder@castwide.com']

  spec.summary = 'A Gamefic extension to provide basic help commands.'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/castwide/gamefic-help'
